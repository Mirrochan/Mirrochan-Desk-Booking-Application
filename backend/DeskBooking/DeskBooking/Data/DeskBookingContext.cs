...
namespace DeskBookingAPI.Data
{
    public class DeskBookingContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RoomModel>().HasData(
                new RoomModel { Id = Guid.Parse("22222222-2222-2222-2222-222222222201"), WorkspaceId = Guid.Parse("b2844205-b49b-4cf1-8389-b7cdb0a54372"), Capacity = 1, UnitType = "room" },
                new RoomModel { Id = Guid.Parse("22222222-2222-2222-2222-222222222202"), WorkspaceId = Guid.Parse("b2844205-b49b-4cf1-8389-b7cdb0a54372"), Capacity = 2, UnitType = "room" },
                new RoomModel { Id = Guid.Parse("22222222-2222-2222-2222-222222222205"), WorkspaceId = Guid.Parse("b2844205-b49b-4cf1-8389-b7cdb0a54372"), Capacity = 5, UnitType = "room" },
                new RoomModel { Id = Guid.Parse("22222222-2222-2222-2222-222222222210"), WorkspaceId = Guid.Parse("b2844205-b49b-4cf1-8389-b7cdb0a54372"), Capacity = 10, UnitType = "room" }
            );

  
            modelBuilder.Entity<RoomModel>().HasData(
                new RoomModel { Id = Guid.Parse("33333333-3333-3333-3333-333333333310"), WorkspaceId = Guid.Parse("51de8af8-a981-49d9-a276-8144384555bb"), Capacity = 10, UnitType = "room" },
                new RoomModel { Id = Guid.Parse("33333333-3333-3333-3333-333333333320"), WorkspaceId = Guid.Parse("51de8af8-a981-49d9-a276-8144384555bb"), Capacity = 20, UnitType = "room" }
            );
        }
    }
}
